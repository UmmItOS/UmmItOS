...
Singleton {
    ...
    // Hyprland's active window border hues (windows.conf col.active_border),
    // darkened, for the one shell surface that wears a turning ring.
    readonly property list<color> ring: ["#5b4bb3", "#6c5fa8", "#15161f", "#3b5a96"]
